...
HD_PWD='C:/Users/Jenny2/Documents/02Semester/FPGA_lab/task3/task3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source block_design_top_wrapper.tcl -notrace
