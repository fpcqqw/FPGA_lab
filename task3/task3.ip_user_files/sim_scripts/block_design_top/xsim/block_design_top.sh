...
#
# Script generated by Vivado on Thu Jul 10 14:45:41 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : block_design_top.sh
...
#
# Usage        : block_design_top.sh
#                block_design_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_design_top.sh [-reset_run]
#                block_design_top.sh [-reset_log]
#                block_design_top.sh [-help]
#
...
# script info
echo -e "block_design_top.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_design_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L xlslice_v1_0_4 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_design_top xil_defaultlib.block_design_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_design_top -key {Behavioral:sim_1:Functional:block_design_top} -tclbatch cmd.tcl -protoinst "protoinst_files/block_design_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_design_top.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./block_design_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: block_design_top.sh [-help]\n\
Usage: block_design_top.sh [-step]\n\
Usage: block_design_top.sh [-lib_map_path]\n\
Usage: block_design_top.sh [-reset_run]\n\
Usage: block_design_top.sh [-reset_log]\n\
Usage: block_design_top.sh [-keep_index]\n\
Usage: block_design_top.sh [-noclean_files]\n\n\
