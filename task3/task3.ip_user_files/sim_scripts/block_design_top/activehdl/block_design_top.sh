...
#                script (type 'block_design_top.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Jenny2/Documents/02Semester/FPGA_lab/task3/task3.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
