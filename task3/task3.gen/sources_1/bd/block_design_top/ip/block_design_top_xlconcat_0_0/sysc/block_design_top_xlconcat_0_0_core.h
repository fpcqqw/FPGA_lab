...
#ifndef _block_design_top_xlconcat_0_0_core_h_
#define _block_design_top_xlconcat_0_0_core_h_
...
class block_design_top_xlconcat_0_0_core : public sc_module 
{
    public: 
       block_design_top_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(block_design_top_xlconcat_0_0_core);
    ...
    virtual ~block_design_top_xlconcat_0_0_core() = default;
   
    void concate_input_port_values()
    {
        sc_bv <52> portConcateVal;
