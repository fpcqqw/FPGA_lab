...
architecture STRUCTURE of MainDesign_BasicLEDController_0_0_BasicLEDController is
  ...
  signal \dutyValue[2]_i_11_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \status[2]_i_4\ : label is "soft_lutpair0";
...
\dutyValue[2]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      ...
      I3 => dutyCounter_reg(16),
      O => \dutyValue[2]_i_10_n_0\
    );
\dutyValue[2]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      I0 => dutyCounter_reg(1),
      I1 => dutyCounter_reg(0),
      I2 => dutyCounter_reg(3),
      I3 => dutyCounter_reg(2),
      O => \dutyValue[2]_i_11_n_0\
    );
\dutyValue[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EEAAEEEA00000000"
    )
        port map (
      I0 => dutyCounter_reg(13),
...
\dutyValue[2]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\dutyValue[2]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0100"
        ...
        port map (
      I0 => dutyCounter_reg(4),
      I1 => dutyCounter_reg(5),
      I2 => dutyCounter_reg(6),
      I3 => \dutyValue[2]_i_11_n_0\,
...
\status[2]_i_11\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\status[2]_i_12\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\status[2]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => counter_reg(7),
      I3 => \status[2]_i_10_n_0\,
      I4 => \status[2]_i_11_n_0\,
      I5 => \status[2]_i_12_n_0\,
      O => \status[2]_i_5_n_0\
    );
\status[2]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\status[2]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
